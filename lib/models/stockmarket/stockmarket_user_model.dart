...
class StockMarketUserModel {
  ...
  factory StockMarketUserModel.fromJson(Map<String, dynamic> json) {
    if (json["stocks"] is List) {
      ...
      return StockMarketUserModel(stocks: {});
    } else {
      // API returned a map
      return StockMarketUserModel(
        stocks: json["stocks"] == null
            ? null
            : Map.from(json["stocks"]).map((k, v) => MapEntry<String, Stock>(k, Stock.fromJson(v))),
      );
    }
  }
...
class Stock {
  ...
  factory Stock.fromJson(Map<String, dynamic> json) => Stock(
        ...
        transactions: json["transactions"] == null
            ? null
            : Map.from(json["transactions"]).map((k, v) => MapEntry<String, Transaction>(k, Transaction.fromJson(v))),
      );
