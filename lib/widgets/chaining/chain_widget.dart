...
class _ChainWidgetState extends State<ChainWidget> with TickerProviderStateMixin {
  ...
  ChainWatcherDefcon _chainWatcherColor = ChainWatcherDefcon.off;
  ...
  void _deactivateChainWatcher() {
    ...
    setState(() {
      _chainWatcherColor = ChainWatcherDefcon.off;
