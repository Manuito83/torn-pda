      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: ExpandablePanel(
            ...
            collapsed: Container(),
            expanded: Platform.isWindows ? const SizedBox.shrink() : expanded(),
            header: header(),
          ),
        ),
      ),
          ...
          children: [
            Row(
              children: [
                ...
                Platform.isWindows ? const SizedBox.shrink() : const Icon(Icons.arrow_drop_down_circle_outlined, size: 16),
              ],
            ),
          ],
        ),
