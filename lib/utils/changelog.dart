...
class _ChangeLogState extends State<ChangeLog> {
  ...
  void _createItems() {
    ...
    String feat2_7_0_4 = "Fixed white flash when using browser with dark themes";
    String feat2_7_0_5 = "Fixed issues with war targets cards and total stats calculation";
