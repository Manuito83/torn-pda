...
class _ChangeLogState extends State<ChangeLog> {
  ...
  void _createItems() {
    ...
    String feat2_6_1_3 = "Browser: restore the previous browsing session, including browser type and active tab, "
        "by long-pressing the T menu floating icon in the Profile section";
    String feat2_6_1_4 = "Profile: properly separated jail from hospital manual notifications";
    String feat2_6_1_5 = "Fixed life sorting in for war targets";
    String feat2_6_1_6 = "Fixed city items being incorrectly identified";
    String feat2_6_1_7 = "Fixed mini profiles not properly redirecting in some devices";
    String feat2_6_1_8 = "Fixed other UI issues";
