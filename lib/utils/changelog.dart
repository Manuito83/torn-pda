...
class _ChangeLogState extends State<ChangeLog> {
  ...
  void _createItems() {
    ...
    String feat3_1_4_2 = "Browser full screen: added two extra tabs to exit and reload the "
    ...
    String feat3_1_2_3 = "Fixed profile pages redirection";
    String feat3_1_2_4 = "Fixed section routing with back button press";
    ...
    String feat3_1_1_3 = "Added wallet money to home screen widget (optional)";
    String feat3_1_1_4 = "Fixed some reported problems with unresponsive browser";
    String feat3_1_1_5 = "Fixed redirection links in Profile and Loot";
    String feat3_1_1_6 = "Fixed iOS 14 crashes";
    ...
    String feat3_0_2_2 = "Double tap energy and nerve bars in Torn to access gym and crimes";
    String feat3_0_2_3 = "Trades can now be filtered out of events alerts";
    String feat3_0_2_4 = "Updated missing Torn icons";
    String feat3_0_2_5 = "Fixed issues when requesting spied stats";
    String feat3_0_2_6 = "Fixed NNB layout margins";
    String feat3_0_2_7 = "Fixed issues with several dialogs in the browser";
    String feat3_0_2_8 = "Fixed information shown in Ranked Wars cards";
    String feat3_0_2_9 = "Fixed rendering issues when sorting items";
    ...
    String feat2_9_3_1 = "Targets can now be sorted by fair fight and last online timestamp";
    ...
    String feat2_9_1_1 = "Fixed steadfast widget";
    String feat2_9_1_2 = "Fixed recent attacks sorting";
    String feat2_9_1_3 = "Fixed issues reported with tabs";
    String feat2_9_1_4 = "Fixed frame rate issues in certain devices";
    ...
    String feat2_9_0_3 = "Fixed several reported issues";
    ...
    String feat2_8_9_2 = "Improved browser stability when using tabs in some devices";
    String feat2_8_9_3 = "Added Hospital Filters example userscripts (by Kwack_Kwack)";
    String feat2_8_9_4 = "Fixed targets export to YATA when using an alternative API key";
    ...
    String feat2_8_7_1 = "Fixed user stale check and alerts persistence";
