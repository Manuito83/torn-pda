...
class _ChangeLogState extends State<ChangeLog> {
  ...
  void _createItems() {
    ...
    String feat2_6_3_2 = "You can now switch between YATA and Torn Stats as your source of spied stats (Settings)";
    String feat2_6_3_3 = "Quick items and crimes can now also be configured from the quick browser";
    String feat2_6_3_4 = "Fixed several reported issues";
