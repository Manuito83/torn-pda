...
class ChangeLogState extends State<ChangeLog> {
  ...
  void _createItems() {
      ...
      ChangeLogItem()
        ...
        ..features = [
          ...
          if (Platform.isAndroid)
            "Browser font size can now be adjusted (Advanced Browser Settings)",
    ...
    const String feat3_1_6_1 =
        "Added split screen mode between browser and app";
    const String feat3_1_6_2 =
        "Browser: long press in title opens shortcuts (default style)";
    ...
    const String feat3_1_6_7 =
        "Fixed issues when adding or updating targets and friends";
    const String feat3_1_6_8 =
        "Fixed retalation alerts (re-enable if still not working)";
    const String feat3_1_6_9 =
        "Fixed show oneself and score dialog settings in jail widget";
    const String feat3_1_6_10 =
        "Fixed JS handlers (get, post, inject) for scripts";
    ...
    const String feat3_1_4_1 =
        "Browser full screen: added gear icon to '...' vertical menu to access further options";
    ...
    const String feat3_1_4_3 =
        "Fixed stock market alerts page for users with no shares";
    const String feat3_1_4_4 = "Fixed profile check widget in named URLs";
    const String feat3_1_4_5 =
        "Fixed widgets and chats not correctly hiding in full screen browser";
    ...
    const String feat3_1_2_1 =
        "Added triple tap gesture to instantly close a browser tab";
    ...
    const String feat3_1_1_1 =
        "Added browser styles (including the former quick browser appearance)";
    ...
    const String feat3_1_1_3 =
        "Added wallet money to home screen widget (optional)";
    const String feat3_1_1_4 =
        "Fixed some reported problems with unresponsive browser";
    ...
    const String feat3_1_0_2 =
        "Browser: complete workflow restructure (faster access and loading)";
    const String feat3_1_0_3 =
        "Browser: quick browser removed, full screen mode and vertical menus added";
    const String feat3_1_0_4 =
        "Browser: long-press menu now also adds a shortcut to the target link";
    const String feat3_1_0_5 =
        "Browser can now be chosen as the default app's launch section";
    const String feat3_1_0_6 =
        "Added Ranked War information and notifications to Profile page";
    const String feat3_1_0_7 =
        "Shortcuts page and all related options have been moved to Settings";
    const String feat3_1_0_8 =
        "Added dual score slider and option to ignore oneself to the Jail widget";
    ...
    const String feat3_1_0_12 =
        "Added competition information to targets and friends details";
    const String feat3_1_0_13 = "Added WTF Revive";
    const String feat3_1_0_14 =
        "Added other minor requested features and improvements";
    const String feat3_1_0_15 =
        "Fixed Loot Rangers loot order in certain conditions";
    const String feat3_1_0_16 =
        "Fixed issues redirecting to attack pages in certain conditions";
    const String feat3_1_0_17 =
        "Fixed issues when launching the app from a notification";
    ...
    const String feat3_0_2_1 =
        "Added option to disallow lateral overscroll issues with iOS 16 (see Settings)";
    const String feat3_0_2_2 =
        "Double tap energy and nerve bars in Torn to access gym and crimes";
    const String feat3_0_2_3 =
        "Trades can now be filtered out of events alerts";
    ...
    const String feat3_0_2_7 =
        "Fixed issues with several dialogs in the browser";
    ...
    v3_0_1.infoString =
        "Hotfix for issues with hidden foreign stocks and stakeouts";
    const String feat3_0_1_1 = "Added stakeouts section";
    const String feat3_0_1_2 =
        "Added native Torn authentication (see Settings)";
    const String feat3_0_1_3 = "Added alerts for medical and booster cooldowns";
    const String feat3_0_1_4 =
        "Added Loot Rangers attack information, alerts and notifications";
    const String feat3_0_1_5 =
        "Added quick favorites menu in the browser tab bar";
    ...
    const String feat3_0_1_8 =
        "Players can now be added to several lists from their profile widget";
    const String feat3_0_1_9 =
        "Ranked Wars sorting and own faction identification has been improved";
    const String feat3_0_1_10 = "Targets can now be sorted by note";
    const String feat3_0_1_11 =
        "Moved reviving services to Settings and added HeLa Revive";
    const String feat3_0_1_12 =
        "Simplified the 'max' button behavior when buying items abroad";
    const String feat3_0_1_13 = "Fixed dark theme sync with Torn";
    const String feat3_0_1_14 =
        "Fixed target level calculation in recent attacks";
    ...
    const String feat2_9_6_3 =
        "Added deep links compatibility for Chrome href links (see Tips)";
    ...
    v2_9_5.infoString =
        "Hotfix for crashes in some iOS devices when launching the browser";
    const String feat2_9_5_1 =
        "Added theme synchronization between app and web (can be disabled)";
    ...
    const String feat2_9_5_3 =
        "Added option to open tab in external browser (URL options dialog)";
    String feat2_9_5_4 = "";
    ...
    const String feat2_9_5_5 =
        "Fixed discrete notifications option (Settings) missing on iOS";
    const String feat2_9_5_6 = "Fixed log copy to clipboard";
    const String feat2_9_5_7 = "Fixed issue with missing shortcuts";
    const String feat2_9_5_8 =
        "Increased timeout with YATA to improve communication";
    ...
    const String feat2_9_3_1 =
        "Targets can now be sorted by fair fight and last online timestamp";
    const String feat2_9_3_2 =
        "Fixed targets colors and sorting after importing from YATA";
    const String feat2_9_3_3 =
        "Fixed crashes when closing the quick browser in some devices";
    const String feat2_9_3_4 =
        "Fixed persistence issue when disabling user scripts";
    ...
    const String feat2_9_2_1 =
        "Added discrete option for alerts and notifications";
    const String feat2_9_2_2 =
        "War: added option to filter out traveling targets";
    ...
    const String feat2_9_2_7 =
        "Fixed retals section issues in landscape orientation";
    ...
    const String feat2_8_9_2 =
        "Improved browser stability when using tabs in some devices";
    const String feat2_8_9_3 =
        "Added Hospital Filters example userscripts (by Kwack_Kwack)";
    const String feat2_8_9_4 =
        "Fixed targets export to YATA when using an alternative API key";
    ...
    const String feat2_8_8_2 =
        "Items: correctly accounts for items in the display cabinet";
    const String feat2_8_8_3 =
        "Browser: fixed external browser option in web contextual menu";
    const String feat2_8_8_4 =
        "Browser: fixed occasional freezes in some devices";
    ...
    const String feat2_8_4_2 =
        "Browser: improved stability issues in some devices";
    ...
    const String feat2_8_2_2 =
        "War: targets in a different country can now be filtered out";
    const String feat2_8_2_3 =
        "War: red (not-okay) targets can now be filtered out";
    const String feat2_8_2_4 =
        "War: factions can now be added from the Ranked Wars list";
    const String feat2_8_2_5 = "War: added persistence to filters";
    const String feat2_8_2_6 =
        "Fixed targets hospitalized in another country not showing as abroad";
    ...
    const String feat2_8_0_2 =
        "Quick items: divided faction refills in energy and nerve (need to be re-added)";
    ...
    const String feat2_8_0_5 =
        "Removed TornCAT Player Filter from default userscripts (discontinued by its developer)";
    ...
    if (Platform.isAndroid)
      v2_7_0.infoString =
          "Hotfix 2 for stability issues still reported after release of v2.7.1";
    v2_7_0.version = 'Torn PDA v2.7.2';
    v2_7_0.date = '25 APR 2022';
    const String feat2_7_0_1 =
        "Browser: added quick items widget in faction armoury";
    const String feat2_7_0_2 =
        "Chaining: the browser now opens as a tab and incorporates all widgets";
    const String feat2_7_0_3 =
        "Chaining: fallen and fedded players are now hidden";
    const String feat2_7_0_4 =
        "War: added quick target filter for online status";
    const String feat2_7_0_5 =
        "Profile: added TornStats chart in the Basic Info card (can be disabled)";
    const String feat2_7_0_6 = "Alerts: increased time options for refills";
    const String feat2_7_0_7 =
        "Travel: foreign stock cards now include bars and cooldown analysis";
    const String feat2_7_0_8 =
        "Travel: added -/+ buttons to items capacity for easier selection";
    const String feat2_7_0_9 = "Added seconds to TCT clock (can be disabled)";
    const String feat2_7_0_10 =
        "Items can now also be filtered by owned/not owned";
    const String feat2_7_0_11 = "Trades: fixed connection with Torn Trader";
    const String feat2_7_0_12 =
        "Fixed white flash when using browser with dark themes";
    const String feat2_7_0_13 =
        "Fixed issues with war targets cards and total stats calculation";
    ...
    const String feat2_6_7_1 =
        "Added points' market value in the networth card";
    const String feat2_6_7_2 =
        "Browser scale can now be changed (browser bar options)";
    const String feat2_6_7_3 =
        "Browser now accepts pinch gestures for zoom (disabled by default)";
    ...
    const String feat2_6_6_2 =
        "War targets can now be sorted by last online time";
    const String feat2_6_6_3 =
        "Added icons and misc info for donator and subscriber status";
    ...
    const String feat2_6_5_1 =
        "Loadouts can now be activated from the quick items widget";
    const String feat2_6_5_2 =
        "Settings: added support for alternative API keys for YATA and Torn Stats";
    const String feat2_6_5_3 =
        "Chaining: targets can now be added or removed from user profiles in Torn";
    const String feat2_6_5_4 =
        "Items: total owned value is now shown and sortable";
    const String feat2_6_5_5 =
        "Shortcuts: increased allowable name length (helpful if using a small font)";
    const String feat2_6_5_6 = "War: fixed hidden targets' dialog scroll";
    const String feat2_6_5_7 = "Bazaar: fixed auto price script";
    const String feat2_6_5_8 =
        "Browser: fixed browsing to custom URLs with mixed letter case";
    const String feat2_6_5_9 =
        "Browser: saving an image to the library should no longer crash the app";
    ...
    const String feat2_6_4_1 =
        "Stock market: added direct access to the stock market in Torn";
    const String feat2_6_4_2 =
        "Shortcuts: updated Bookies link (needs to be readded)";
    const String feat2_6_4_3 =
        "Userscripts: added JavaScript API to allow cross-origin http requests [by Knoxby]";
    const String feat2_6_4_4 =
        "War: reviving services are now accessible in the War page (Settings)";
    const String feat2_6_4_5 =
        "Items: fixed owned items not correctly filtering on launch";
    const String feat2_6_4_6 =
        "Quick items: fixed incorrect inventory quantities on launch";
    const String feat2_6_4_7 =
        "Spies: fixed some Torn Stats spied stats not showing for some players";
    ...
    const String feat2_6_3_3 =
        "Added status icons for banks, vault and loan (filter icons in Profile options)";
    const String feat2_6_3_4 =
        "You can now switch between YATA and Torn Stats as your source of spied stats (Settings)";
    const String feat2_6_3_5 =
        "Quick items and crimes can now also be configured from the quick browser";
    ...
    const String feat2_6_2_2 =
        "Added cans to estimated stats (needs war targets update)";
    ...
    const String feat2_6_1_2 =
        ...
        "(disabled by default)";
    const String feat2_6_1_3 =
        "Chaining: the faction assist requests now also sends extended information and stats";
    const String feat2_6_1_4 =
        "Browser: long-pressing a link in Torn will open a contextual menu with options";
    ...
    const String feat2_6_1_7 =
        "Browser: you can now choose the colour of the tabs hide bar";
    const String feat2_6_1_8 =
        "Profile: properly separated jail from hospital manual notifications";
    const String feat2_6_1_9 =
        "Fixed incorrect spied stats total and dexterity comparison";
    ...
    const String feat2_6_1_12 =
        "Fixed mini profiles not properly redirecting in some devices";
    ...
    const String feat2_6_0_4 =
        "Chaining: added option to skip first target as well (disabled by default)";
    ...
    const String feat2_6_0_7 =
        "Chain widget: you can now choose the alert activation triggers";
    const String feat2_6_0_8 =
        "Alerts (refills): you can now choose the notification time";
    const String feat2_6_0_9 =
        "Alerts (stock market): added overall value and profit information";
    const String feat2_6_0_10 =
        "Alerts (stock market): alerts can now be based on gain/loss percentages";
    const String feat2_6_0_11 =
        "Friendly factions can now also be added using members' IDs";
    const String feat2_6_0_12 =
        "Fixed respect and fair fight not being properly recorded in some cases";
    ...
    const String feat2_5_2_1 =
        "Added jail widget with quick bail/bust and filters";
    ...
    const String feat2_5_2_7 =
        "Fixed some quick crimes (please remove/add the crime again if you were affected)";
    ...
    const String feat2_5_1_1 =
        "Fixed some browsing issues when not using tabs in the quick browser";
    const String feat2_5_1_2 =
        "Fixed browsing history not working properly after visiting certain pages";
    ...
    const String feat2_5_0_1 =
        "Browser: added tabs (visit the Tips section for more information)";
    const String feat2_5_0_2 =
        "Browser: added pull to refresh to the main browser (disabled by default)";
    const String feat2_5_0_3 =
        "Profile: added section header with main icons and wallet information";
    const String feat2_5_0_4 =
        "Profile: added pull to refresh in the Profile section";
    const String feat2_5_0_5 =
        "Profile: added more detail to bazaar information";
    const String feat2_5_0_6 =
        "Scripts: added Company Activity and fixed Racing Presets";
    const String feat2_5_0_7 =
        "Chaining: removed Torn Attack Central (service discontinued)";
    const String feat2_5_0_8 =
        "Fixed some userscripts with wildcards not correctly activating";
    ...
    const String feat2_4_3_2 =
        "Added display cabinet items to the inventory count shown in the foreign stocks page";
    const String feat2_4_3_3 =
        "Unedited example user scripts will now update automatically as necessary with each app update";
    const String feat2_4_3_4 =
        "Fixed disabled user scripts reactivating when app is launched";
    const String feat2_4_3_5 =
        "Fixed total bazaar value shown in the Profile section";
    ...
    const String feat2_4_2_2 =
        "Travel: you can now filter foreign stocks by inventory quantity";
    const String feat2_4_2_3 =
        "Travel: MAX buy button can now also be used to buy additional items above the limit";
    const String feat2_4_2_4 =
        "Travel: added custom (seat belt) sound for travel notifications";
    const String feat2_4_2_5 =
        "Travel: added depletion rate information to foreign stocks";
    ...
    const String feat2_4_2_8 =
        "Fixed an issue preventing some userscripts from working if using wildcards in the URL";
    ...
    const String feat2_4_0_1 =
        "Added alerts for stock exchange price gain/loss";
    const String feat2_4_0_2 =
        "Added Arson Warehouse support in the Trade Calculator";
    const String feat2_4_0_3 = "Loot: added Tiny";
    const String feat2_4_0_4 =
        "Loot: click the NPC's portrait to visit the profile";
    const String feat2_4_0_5 =
        "Profile: you can now choose which section to visit when tapping the life bar";
    const String feat2_4_0_6 =
        "Profile: you can now edit active shortcuts (left swipe)";
    const String feat2_4_0_7 =
        "Profile: added caution message if visiting the gym while stacking";
    ...
    const String feat2_4_0_9 =
        "Chaining: you can now check targets' status after fetching them from TAC";
    const String feat2_4_0_10 =
        "Chaining: added options (URL copy, navigation, shortcuts) to chaining browser";
    const String feat2_4_0_11 =
        "Chaining: you can now tap anywhere in a target's card to trigger the attack browser";
    const String feat2_4_0_12 =
        "Browser: added MAX buttons when buying from the bazaar";
    const String feat2_4_0_13 =
        "Browser: you can now disable the native link preview windows when long-pressing";
    const String feat2_4_0_14 =
        "Browser: TornCAT Player Filter script updated to include API comment";
    const String feat2_4_0_15 =
        "Fixed issue with screen turning off when chain watcher is in use";
    const String feat2_4_0_16 =
        "Fixed connectivity with some bluetooth devices";
    const String feat2_4_0_17 =
        "Fixed foreign stock items identification and uploads";
    const String feat2_4_0_18 =
        "Fixed issues caused by targets with life over max";
    const String feat2_4_0_19 =
        "Fixed recent attacks cards errors in certain conditions";
    const String feat2_4_0_20 =
        "Fixed other UI related issues reported by users";
    ...
    const String feat2_3_5_3 =
        "Profile: added shortcuts below error message when Torn API is down";
    const String feat2_3_5_4 =
        "Fixed duplicated notifications in some devices with the app on the foreground";
    const String feat2_3_5_5 =
        "Fixed error when using Awards for the first time in a while";
    ...
    const String feat2_3_4_1 =
        "Alerts: added refills (energy, nerve, casino tokens).";
    ...
    const String feat2_3_4_4 =
        "Profile: added bazaar status and dialog with details to the status card.";
    const String feat2_3_4_5 =
        "Profile: you can now copy or share the information in the Basic Info card.";
    const String feat2_3_4_6 = "Loot: added pull to refresh functionality.";
    const String feat2_3_4_7 =
        "Browser: fixed issue preventing the Trade Calculator widget from activating.";
    const String feat2_3_4_8 =
        "Scripts: updated TornCAT example and the repository with new scripts.";
    ...
    const String feat2_3_3_1 =
        "Added a 5 minutes option for manual Loot notifications.";
    const String feat2_3_3_2 =
        "Added networth information to players' profiles (disabled by default).";
    const String feat2_3_3_3 =
        "Adapted quick items result box to work with dark mode.";
    const String feat2_3_3_4 =
        "Fixed an issue preventing Torn Trader from authenticating users.";
    ...
    const String feat2_3_2_6 =
        "Shortcuts: Stock Market URL has been corrected and Portfolio has been removed.";
    const String feat2_3_2_7 =
        "Profile: added racing, reviving and hunting skills to the basic info card.";
    const String feat2_3_2_8 =
        "Travel: flag filters can now be sorted alphabetically and by flight time.";
    const String feat2_3_2_9 =
        "Travel: the quick return icon now needs to be pressed twice to avoid erroneous activations.";
    const String feat2_3_2_10 =
        "Travel: increased width of the capacity slider to make selection easier.";
    ...
    const String feat2_3_2_12 =
        "Awards: added button to enable or disable all filters at once.";
    const String feat2_3_2_13 =
        "Alerts: improved travel alerts reliability, even if the API goes down temporarily.";
    ...
    const String feat2_3_2_16 =
        "Fixed Trade widget not activating in certain devices.";
    const String feat2_3_2_17 =
        "Fixed crash when clearing browser cache in certain devices.";
    ...
    const String feat2_3_0_3 =
        "Browser: added estimated stats to players' profiles.";
    ...
    const String feat2_3_0_7 =
        "Chaining: changed sorting by note color to match YATA's (G-Y-R-OFF or OFF-R-Y-G).";
    const String feat2_3_0_8 =
        "Chaining: you can now filter targets by note color.";
    const String feat2_3_0_9 =
        "Chaining: fixed TAC stats notes not showing correctly.";
    ...
    const String feat2_3_0_11 =
        "Chaining: target cards now show flat respect. Added fair fight.";
    ...
    const String feat2_3_0_15 =
        "Profile: fixed company name when working for a public company.";
    const String feat2_3_0_16 =
        "Profile: fixed participants readiness check for OCs.";
    const String feat2_3_0_17 =
        "Travel: Improved foreign items layout for narrow screens.";
    const String feat2_3_0_18 =
        "Settings: moved browser options to a dedicated section to reduce complexity.";
    const String feat2_3_0_19 = "Corrected pixel density for certain devices.";
    const String feat2_3_0_20 =
        "Corrected Torn links not working when the website returns an unsecure (http) url.";
    const String feat2_3_0_21 =
        "Corrected targets sync issues caused by API changes.";
    ...
    const String feat2_2_0_1 =
        "Travel: added foreign stock graphs with last 36 hours data";
    ...
    const String feat2_2_0_3 =
        "Travel: added automatic alerts for items restock (Alerts section)";
    ...
    const String feat2_2_0_5 =
        "Travel: arrival times are now shown in the main stock card";
    const String feat2_2_0_6 =
        "Travel: items can now be sorted by arrival time";
    const String feat2_2_0_7 =
        "Travel: added calculation of money to carry and direct access to vaults";
    ...
    const String feat2_2_0_9 =
        "Travel: you can now optionally hide the airplane while flying (Settings)";
    const String feat2_2_0_10 =
        "Profile: you can now activate a manual notification for just before hospital release";
    ...
    const String feat2_2_0_14 =
        "Profile: you can now manually sort the cards shown in the Profile section";
    ...
    const String feat2_2_0_16 =
        "Profile: added job points to the basic information card";
    const String feat2_2_0_17 =
        "Chaining: added fair fight to recent attacks cards";
    ...
    const String feat2_2_0_21 =
        "Added option to clear the browser's cache (Settings)";
    ...
    const String feat2_1_0_1 =
        "Added Torn Attack Central mobile interface (see Chaining section)";
    ...
    const String feat2_1_0_3 =
        "You can now use your shortcuts directly from the browser (tap the page title)";
    const String feat2_1_0_4 =
        "Added the quick items widget to the chaining browser";
    ...
    const String feat2_1_0_9 =
        "You can now select the vibration pattern for notifications (Settings)";
    const String feat2_1_0_10 = "Fixed Discord link";
    const String feat2_1_0_11 =
        "Fixed issues when launching the external browser";
    const String feat2_1_0_12 = "Fixed URL copying";
    const String feat2_1_0_13 =
        "Fixed education warning when there are no pending courses";
    ...
    const String feat2_0_0_5 =
        "You can now highlight your name in chat (choose color or disable in Settings)";
    const String feat2_0_0_6 =
        "Added a new button that allows to temporarily remove all chat windows from Torn";
    ...
    const String feat2_0_0_10 =
        "You can now select the number of events and messages to show in the Profile section";
    const String feat2_0_0_11 =
        "Added confirmation dialog to prevent exiting Torn PDA inadvertently (can be disabled)";
    const String feat2_0_0_12 =
        "Added Loot and Awards to the default launch section selector";
    const String feat2_0_0_13 =
        "Browser widgets should open faster and more reliably";
    const String feat2_0_0_14 =
        "Corrected travel money checks showing a warning when the exact amount was brought";
    ...
    const String feat1_9_7_1 =
        "Loot: fixed bug preventing notifications from working properly";
    ...
    const String feat1_9_6_4 =
        "Alerts section can now be correctly scrolled in smaller screens";
    ...
    const String feat1_9_5_1 =
        "Fixed shortcuts menu persistence after app is closed";
    ...
    const String feat1_9_4_4 =
        "Browser: added quick controls (back, forward and refresh) for the quick browser";
    ...
    const String feat1_9_3_2 =
        "Corrected emojis representation in message titles";
    ...
    const String feat1_9_2_2 =
        "Profile: added a new card for received messages";
    const String feat1_9_2_3 =
        "Profile: added option to configure which cards are expanded or collapsed by default";
    const String feat1_9_2_4 =
        "Profile: the Basic Information card can now be collapsed";
    const String feat1_9_2_5 =
        "Browser: added loading progress bar (can be disabled)";
    const String feat1_9_2_6 =
        "Browser: quick crimes are now placed at the bottom when using a bottom app bar";
    const String feat1_9_2_7 = "Increased size of quick browser";
    const String feat1_9_2_8 =
        "Fixed error with chaining indications for players with no faction";
    ...
    const String feat1_9_1_2 =
        "Profile: added addiction icon and information to miscellaneous";
    const String feat1_9_1_3 =
        "Profile: added effective battle stats calculation";
    ...
    const String feat1_9_1_5 =
        "Chaining: added flags and travel direction for your targets";
    const String feat1_9_1_6 =
        "Settings: you can now place the application bar at the bottom of the screen";
    const String feat1_9_1_7 =
        "Fixed screen issues in several devices (wrong tap location, zoomed-in screen, loading times)";
    const String feat1_9_1_8 =
        "Fixed scroll not returning to the correct place after refreshing a page in the browser";
    const String feat1_9_1_9 =
        "Fixed issues with some devices and keyboards (special chars and autocorrect not displaying)";
    const String feat1_9_1_10 =
        "Fixed dropdown menus not opening in some tablets";
    ...
    const String feat1_9_0_2 =
        "Quick actions: long press app icon (supported devices) to launch Torn from home screen";
    ...
    const String feat1_9_0_4 =
        "Profile: added stats, points and other useful information";
    ...
    const String feat1_9_0_7 =
        "Bazaar: added button to fill maximum quantities automatically";
    ...
    const String feat1_8_6_3 =
        "Profile: racing status added to the miscellaneous card";
    ...
    const String feat1_8_5_4 =
        "Fixed an issue where the target note could not be updated right after attacking";
    ...
    const String feat1_8_1_1 =
        "Loot: increased trigger options for loot notifications";
