...
class ChangeLogState extends State<ChangeLog> {
  ...
  void _createItems() {
    ...
    const String feat3_1_5_2 = "Fixed energy and nerve bars double tap";
    const String feat3_1_5_3 = "Fixed show oneself option in Jail";
    const String feat3_1_5_4 = "Fixed JS handlers (get, post, inject) for scripts";
    const String feat3_1_5_5 = "Update packages";
