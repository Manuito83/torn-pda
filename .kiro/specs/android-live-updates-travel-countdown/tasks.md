...
- [x] 2. Implement Android MethodChannel handler and LiveUpdateManager
...
- [x] 2.2 Build LiveUpdateManager with eligibility gating and session registry
  ...
  - _Requirements: Capability Scoping & Device Eligibility, Interaction & Surface Behavior, Lifecycle Management & Fallback Handling_
- [x] 2.3 (P) Implement EligibilityEvaluator, CapabilityStore, and broadcast listeners
...
- [x] 3.1 Scaffold AndroidLiveUpdateAdapter with NoOp fallback
...
- [x] 3.2 (P) Add OemCapsuleAdapter decorations for OnePlus 13
...
- [x] 4. Testing and telemetry instrumentation
- [x] 4.1 Write Flutter unit tests for bridge and controller changes
...
- [x] 4.2 Add Kotlin unit/instrumentation tests for manager and eligibility flow
