...
- [Javascript-webview communication](#javascript-webview-communication)
...
- [Share File Handler](./share-file-handler.md) – Share files (CSV, images, etc.) generated by scripts to the native system.
- [Tab State Handler](./tab-state-handler.md) – Expose tab UID plus active/visibility flags via handler and `tornpda:tabState` events.
